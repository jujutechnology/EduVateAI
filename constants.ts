...
export const SUBJECTS: Subject[] = [
  ...
  // Social Studies
  { id: 'what-is-sociology', name: 'What is Sociology?', category: 'Social Studies', description: 'Study the development and structure of human society.', graphicId: '/icons/socialstudies.png' },
  { id: 'self-development', name: 'Theories of Self-Development', category: 'Social Studies', description: 'Understand how our identity and personality are formed.', graphicId: '/icons/socialstudies.png' },
  { id: 'what-is-learning', name: 'What is Learning?', category: 'Social Studies', description: 'Explore the cognitive processes behind how we acquire knowledge.', graphicId: '/icons/socialstudies.png' },
  { id: 'us-government', name: 'Foundations of US Government', category: 'Social Studies', description: 'Learn how the U.S. government is structured and functions.', graphicId: '/icons/socialstudies.png' },
  { id: 'world-geography', name: 'World Geography', category: 'Social Studies', description: 'Explore the continents, countries, and cultures of our planet.', graphicId: '/icons/socialstudies.png' },
  ...
  { id: 'anatomy-physiology', name: 'Overview of Anatomy & Physiology', category: 'Science', description: 'A detailed look at the structure and function of the human body.', graphicId: '/icons/anatomy.png' },
  ...
  { id: 'genetics-basics', name: 'Genetics & Heredity', category: 'Science', description: 'Uncover the secrets of DNA and how traits are passed down.', graphicId: '/icons/genetics.png' },
  ...
  // Maths
  { id: 'algebra-basics', name: 'Algebra Basics', category: 'Maths', description: 'Grasp the fundamentals of variables and equations.', graphicId: '/icons/maths.png' },
  { id: 'geometry-fundamentals', name: 'Geometry Fundamentals', category: 'Maths', description: 'Learn about shapes, lines, angles, and spaces.', graphicId: '/icons/maths.png' },
  { id: 'algebra-trigonometry', name: 'Algebra and Trigonometry', category: 'Maths', description: 'Bridge algebra and geometry to solve new problems.', graphicId: '/icons/maths.png' },
  { id: 'calculus', name: 'Calculus', category: 'Maths', description: 'Explore the mathematics of continuous change.', graphicId: '/icons/maths.png' },
  { id: 'college-algebra', name: 'College Algebra', category: 'Maths', description: 'Prepare for higher-level mathematics courses.', graphicId: '/icons/maths.png' },
  { id: 'contemporary-math', name: 'Contemporary Math', category: 'Maths', description: 'Apply mathematical concepts to modern-day problems.', graphicId: '/icons/maths.png' },
  { id: 'developmental-math', name: 'Developmental Math', category: 'Maths', description: 'Build your foundational math skills from the ground up.', graphicId: '/icons/maths.png' },
  { id: 'precalculus', name: 'Precalculus', category: 'Maths', description: 'Get ready for the world of calculus and advanced math.', graphicId: '/icons/maths.png' },
  { id: 'data-science', name: 'Principles of Data Science', category: 'Maths', description: 'Learn to interpret, analyze, and visualize data.', graphicId: '/icons/maths.png' },
  { id: 'secondary-math', name: 'Secondary Math', category: 'Maths', description: 'Core math concepts for middle and high school students.', graphicId: '/icons/maths.png' },
  { id: 'statistics', name: 'Statistics', category: 'Maths', description: 'Understand data collection, analysis, and probability.', graphicId: '/icons/maths.png' },
  { id: 'k-8-math', name: 'K-8 Math', category: 'Maths', description: 'Core concepts for elementary and middle school learners.', graphicId: '/icons/maths.png' },
  ...
  // Computer Science
  { id: 'data-structures', name: 'Intro to Data Structures & Algorithms', category: 'Computer Science', description: 'Understand how data is organized and processed efficiently.', graphicId: '/icons/computerScience.png' },
  { id: 'logical-statements', name: 'Logical Statements', category: 'Computer Science', description: 'Learn the building blocks of computer logic and reasoning.', graphicId: '/icons/computerScience.png' },
  { id: 'intro-to-coding', name: 'Introduction to Coding', category: 'Computer Science', description: 'Learn the basic principles of programming and computational thinking.', graphicId: '/icons/computerScience.png' },
  { id: 'how-internet-works', name: 'How the Internet Works', category: 'Computer Science', description: 'Discover the technology that connects the world.', graphicId: '/icons/computerScience.png' },
